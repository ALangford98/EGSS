...
Newest-first, one entry per landed change: what was built, what broke, and
what the measurement said. Moved out of `README.md` (2026-09-15) so the
README can stay a reasonably-sized front door — this file is the detailed
record behind it. ~170k tokens over hundreds of entries; **meant to be
