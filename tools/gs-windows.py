#!/usr/bin/env python3
"""Bridge between KWin and the GS wallpaper.

    ./gs.py windows        (or run this directly)
...
SCRIPT = os.path.join(ROOT, "kwin", "gs-windows.js")
SCRIPT_NAME = "gs-windows"

BUS_NAME = "org.gs.Wallpaper"
OBJECT_PATH = "/Windows"
INTERFACE = "org.gs.Windows"


def state_path():
    runtime = os.environ.get("XDG_RUNTIME_DIR") or tempfile.gettempdir()
    return os.path.join(runtime, "gs-windows")
