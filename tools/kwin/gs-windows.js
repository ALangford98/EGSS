// Reports the geometry of every ordinary window to the GS wallpaper.
//
...
// service somebody else owns -- `tools/gs-windows.py`, which writes what
...
function report() {
    ...
    callDBus("org.gs.Wallpaper", "/Windows", "org.gs.Windows",
             "Update", lines.join(";"));
}
