...
namespace GS {
	...
	{
		GS_PROFILE_SCOPE("Physics3D::Step");
		...
		{
			GS_PROFILE_SCOPE("Physics3D::Solve");
	...
	{
		GS_PROFILE_SCOPE("Physics3D::Broadphase+Narrowphase");
	...
	{
		GS_PROFILE_SCOPE("Physics3D::IntegrateVelocities");
	...
	{
		GS_PROFILE_SCOPE("Physics3D::IntegratePositions");
	...
	{
		GS_PROFILE_SCOPE("Physics3D::CorrectPositions");
