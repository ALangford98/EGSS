...
#include "gspch.h"
#include "GS/Core.h"
#include "GS/Physics/RigidBody2D.h"   // BodyType, shared by both dimensions
#include "GS/Physics/Heightfield3D.h"
