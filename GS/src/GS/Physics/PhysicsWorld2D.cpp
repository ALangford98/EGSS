...
namespace GS {
	...
	void PhysicsWorld2D::Step(float dt)
	{
		...
		GS_PROFILE_SCOPE("Physics::Solve");
	...
	{
		GS_PROFILE_SCOPE("Physics::IntegrateVelocities");
	...
	{
		GS_PROFILE_SCOPE("Physics::IntegratePositions");
	...
	{
		GS_PROFILE_SCOPE("Physics::Broadphase+Narrowphase");
	...
	{
		GS_PROFILE_SCOPE("Physics::CorrectPositions");
	...
	{
		GS_PROFILE_SCOPE("Physics::Sleeping");
