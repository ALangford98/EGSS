...
namespace GS {
	...
	// GS::Material -- parsing must not need a GL context, and a model should
	// be loadable in a test that has no window.
	struct GS_API GltfImage
	{
		std::string Name;
